package com.example.khabar.data
...
class LocalUserManagerImpl(private val context: Context): LocalUserManager {
    ...
    override fun readAppEntry(): Flow<Boolean> {
        return context.dataStore.data.map { prefrenses ->
            prefrenses[PreferencesKeys.APP_ENTRY]?: false
        }
    }
}

//This is an extension value for the Context, this will allow us to access the value using the context
